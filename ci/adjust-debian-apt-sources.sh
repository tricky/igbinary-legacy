...
if [ "x${ID:-linux}" = "xdebian" ] && { [ "x${VERSION_CODENAME:-unknown}" = "xbuster" ] || [ "x${VERSION_CODENAME:-unknown}" = "xstretch" ]; } ; then    echo "Adjusting APT sources for Debian Stretch or Buster"
